...
df = pd.read_csv("../data/analthemed_reviews.csv")
...
plt.tight_layout()
plt.savefig("task-4/figures/theme_counts.png")
plt.close()

# 3. Word Cloud of Reviews (all reviews concatenated)
text = " ".join(df['review'].dropna().astype(str).values)
...
plt.tight_layout()
plt.savefig("task-4/figures/wordcloud.png")
plt.close()

print("✅ Visualizations saved to task-4/figures/")
...
with open("task-4/report.md", "w") as f:
    f.write(report_text)

print("✅ Report saved to task-4/report.md")
